...
<body>
  ...
  <aside class="r-sidebar" id="rSidebar">
    ...
    <nav class="r-sidebar-nav">
      ...
      <a href="#" class="r-nav-item active"><i class="bi bi-gear r-nav-icon"></i><span class="r-nav-text">Settings</span></a>
      <a href="resident-help.php" class="r-nav-item"><i class="bi bi-question-circle r-nav-icon"></i><span class="r-nav-text">Help & Support</span></a>
    </nav>
    <div class="r-sidebar-footer">
      <div class="r-user-row">
        <div class="r-user-avatar"><?= $initials ?></div>
        <div class="r-user-info"><span class="r-user-name"><?= $fullName ?></span><span class="r-user-sub"><?= $residentId ?></span></div>
        <a href="logout.php" class="r-logout-btn"><i class="bi bi-box-arrow-right"></i></a>
      </div>
    </div>
  </aside>
