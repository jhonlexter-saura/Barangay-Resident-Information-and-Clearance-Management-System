...
<head>
  ...
  <title>MySerbisyo — Cedula / Community Tax Certificate</title>
  ...
  <div class="r-main" id="rMain">
    ...
    <main class="r-content">
      ...
      <div class="svc-page-hero">
        <div class="svc-hero-eyebrow"><i class="bi bi-card-heading"></i> Service Request</div>
        <div class="svc-hero-title">Cedula / Community Tax Certificate</div>
        <div class="svc-hero-sub">Annual community tax requirement for all residents 18 years and above</div>
        <div class="svc-hero-meta">
          <div class="svc-hero-fee">₱25.00+</div>
      ...
      <div class="svc-steps">
        ...
        <div class="svc-step" id="step-indicator-1">
          ...
          <span class="step-label">Tax Details</span>
        </div>
      ...
      <div class="svc-layout">
        ...
        <div class="svc-form-card">
          <div class="svc-form-header">
            <div class="svc-form-header-icon" style="background:#e6f7ef; color:#1a9e5f;">
              <i class="bi bi-card-heading"></i>
            </div>
            <div class="svc-form-header-text">
              <div class="svc-form-title">Cedula / Community Tax Certificate</div>
          ...
          <div class="svc-form-body">
            <form id="svcForm" novalidate>
              ...
              <div class="svc-field-section">
                ...
                <div class="svc-field">
                  <label class="svc-label" for="occupation">Occupation<span class="req">*</span></label>
                  <input type="text" class="svc-input" id="occupation" name="occupation" placeholder="e.g. Teacher, Farmer, Self-employed">
                  <span class="svc-error-msg" id="occupation-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="employer_name">Employer / Business Name<span class="req">*</span></label>
                  <input type="text" class="svc-input" id="employer_name" name="employer_name" placeholder="e.g. DepEd, Self-employed">
                  <span class="svc-error-msg" id="employer_name-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="income">Annual Income (₱)<span class="req">*</span></label>
                  <input type="number" class="svc-input" id="income" name="income" placeholder="e.g. 180000">
                  <span class="svc-error-msg" id="income-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="property_val">Annual Property Value (₱, if any)<span class="req">*</span></label>
                  <input type="number" class="svc-input" id="property_val" name="property_val" placeholder="e.g. 500000">
                  <span class="svc-error-msg" id="property_val-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>
        ...
        <div class="svc-sidebar">
          ...
          <div class="svc-summary-card">
            ...
            <div class="svc-summary-body">
              <div class="svc-summary-row">
                ...
                <span class="svc-summary-val">Cedula / Community Tax Certificate</span>
              </div>
              <div class="svc-summary-row">
              ...
              <div class="svc-summary-row">
                ...
                <span class="svc-summary-val fee">₱25.00+</span>
              </div>
            </div>
          </div>
          ...
          <div class="svc-info-card">
            ...
            <div class="req-checklist">
              ...
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> Previous year's Cedula (for renewal)</div>
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> Latest payslip or ITR (for employed applicants)</div>
            </div>
          </div>
