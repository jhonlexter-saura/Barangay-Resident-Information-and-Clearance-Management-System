...
<head>
  ...
  <title>KALASUNGAY — Real Property Tax Payment</title>
  ...
  <div class="r-main" id="rMain">
    ...
    <main class="r-content">
      ...
      <div class="svc-page-hero">
        <div class="svc-hero-eyebrow"><i class="bi bi-cash-coin"></i> Service Request</div>
        <div class="svc-hero-title">Real Property Tax Payment</div>
        <div class="svc-hero-sub">Annual real property tax for land, buildings, and improvements</div>
        <div class="svc-hero-meta">
          <div class="svc-hero-fee">Computed</div>
      ...
      <div class="svc-layout">
        ...
        <div class="svc-form-card">
          <div class="svc-form-header">
            <div class="svc-form-header-icon" style="background:#e8f5e8; color:#16a34a;">
              <i class="bi bi-cash-coin"></i>
            </div>
            <div class="svc-form-header-text">
              <div class="svc-form-title">Real Property Tax Payment</div>
          ...
          <div class="svc-summary-card">
            ...
            <div class="svc-summary-body">
              <div class="svc-summary-row">
                ...
                <span class="svc-summary-val">Real Property Tax Payment</span>
              </div>
              <div class="svc-summary-row">
              ...
              <div class="svc-summary-row">
                ...
                <span class="svc-summary-val fee">Computed</span>
              </div>
            </div>
          </div>
