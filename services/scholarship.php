...
<head>
  ...
  <title>MySerbisyo — Scholarship Application</title>
  ...
  <div class="r-main" id="rMain">
    ...
    <main class="r-content">
      ...
      <div class="svc-page-hero">
        <div class="svc-hero-eyebrow"><i class="bi bi-mortarboard-fill"></i> Service Request</div>
        <div class="svc-hero-title">Scholarship Application</div>
        <div class="svc-hero-sub">LGU-funded education assistance for qualified residents, SY 2026–2027</div>
        <div class="svc-hero-meta">
          <div class="svc-hero-fee">Free</div>
          <div class="svc-hero-fee-label">Processing Fee</div>
          <div class="svc-hero-time"><i class="bi bi-clock"></i> 5–7 business days</div>
        </div>
      </div>
      ...
      <div class="svc-steps">
        ...
        <div class="svc-step" id="step-indicator-2">
          ...
          <span class="step-label">Family Background</span>
        </div>
        <div class="svc-step" id="step-indicator-3">
          <div class="step-num">4</div>
          <span class="step-label">Upload Docs</span>
        </div>
        <div class="svc-step" id="step-indicator-4">
      ...
      <div class="svc-layout">
        ...
        <div class="svc-form-card">
          <div class="svc-form-header">
            <div class="svc-form-header-icon" style="background:#e8f3fc; color:#0369a1;">
              <i class="bi bi-mortarboard-fill"></i>
            </div>
            <div class="svc-form-header-text">
              <div class="svc-form-title">Scholarship Application</div>
          ...
          <div class="svc-form-body">
            <form id="svcForm" novalidate>
              ...
              <div class="svc-field-section">
                ...
                <div class="svc-field">
                  <label class="svc-label" for="school">School / University<span class="req">*</span></label>
                  <input type="text" class="svc-input" id="school" name="school" placeholder="e.g. Bukidnon State University">
                  <span class="svc-error-msg" id="school-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="course">Course / Grade Level<span class="req">*</span></label>
                  <input type="text" class="svc-input" id="course" name="course" placeholder="e.g. BS Nursing, Grade 11">
                  <span class="svc-error-msg" id="course-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="school_year">School Year<span class="req">*</span></label>
                  <input type="text" class="svc-input" id="school_year" name="school_year" placeholder="e.g. 2026–2027">
                  <span class="svc-error-msg" id="school_year-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="gwa">General Average (Last Year)<span class="req">*</span></label>
                  <input type="text" class="svc-input" id="gwa" name="gwa" placeholder="e.g. 90.5">
                  <span class="svc-error-msg" id="gwa-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>

                <div class="svc-field">
                  <label class="svc-label" for="guardian_income">Guardian's Monthly Income (₱)<span class="req">*</span></label>
                  <input type="number" class="svc-input" id="guardian_income" name="guardian_income" placeholder="e.g. 12000">
                  <span class="svc-error-msg" id="guardian_income-err"><i class="bi bi-exclamation-circle"></i> This field is required</span>
                </div>
        ...
        <div class="svc-sidebar">
          ...
          <div class="svc-summary-card">
            ...
            <div class="svc-summary-body">
              <div class="svc-summary-row">
                ...
                <span class="svc-summary-val">Scholarship Application</span>
              </div>
              <div class="svc-summary-row">
              ...
              <div class="svc-summary-row">
                ...
                <span class="svc-summary-val">5–7 business days</span>
              </div>
              <div class="svc-summary-row">
          ...
          <div class="svc-info-card">
            ...
            <div class="req-checklist">
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> Barangay Indigency Certificate</div>
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> Latest Report Card / Transcript of Records</div>
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> 2x2 ID photo</div>
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> Parent/Guardian Valid ID</div>
              <div class="req-item"><i class="bi bi-check-circle-fill"></i> Enrollment Form or Acceptance Letter (for college)</div>
            </div>
          </div>
          ...
          <div class="svc-cart-section">
            ...
            <button class="btn-add-cart" id="addCartBtn"
              onclick="addToCart('Scholarship Application', 'Free', 'bi-mortarboard-fill', '#e8f3fc', '#0369a1')">
